              ...
              brokerages.map(b => (
                <>
                  <tr
                    ...
                    style={{
                      cursor: 'pointer',
                      background: expanded === b.id ? 'rgba(255,255,255,0.03)' : 'transparent',
                    }}
                  ...
                  >
                    ...
                    <td style={{ ...tableCellStyle, color: '#888', fontSize: 12 }}>
                      {b.email ?? '—'}
                    </td>
                            ...
                            <tbody>
                              {transfers[b.id].map(t => (
                                <tr key={t.id}>
                                  ...
                                  <td style={{ ...tableCellStyle, fontSize: 12, color: '#888' }}>
                                    {t.to_user?.email ?? '—'}
                                  </td>
