...
import { SectionProps, SectionCard, AdminInput, LoadingRow, tableHeaderStyle, tableCellStyle } from './shared'
      ...
      <SectionCard title="Manual Credit Adjustment">
        <form onSubmit={e => void handleAdjust(e)} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            ...
            <AdminInput value={adjustDelta}  onChange={setAdjustDelta}  placeholder="Delta (e.g. 50 or -10)" style={{ width: 140 }} />
            <AdminInput value={adjustReason} onChange={setAdjustReason} placeholder="Reason / note" style={{ flex: 1, minWidth: 200 }} />
