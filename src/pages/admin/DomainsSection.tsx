...
const DOMAINS = [
  { domain: 'traydbook.com',        label: 'Marketing Site', env: 'Production', status: 'operational', note: 'Public-facing landing page. Hosted on Replit.' },
  { domain: 'app.traydbook.com',    label: 'Web App',        env: 'Production', status: 'operational', note: 'Main application. Supabase backend, React frontend.' },
  { domain: 'secure.traydbook.com', label: 'Auth / API',     env: 'Production', status: 'operational', note: 'Supabase auth and API endpoint. Managed by Supabase.' },
]
