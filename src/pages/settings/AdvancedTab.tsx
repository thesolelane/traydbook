...
export default function AdvancedTab() {
  ...
  async function handleRemoveWallet() {
    if (
      !confirm(
        'Remove your wallet? Your public key will be cleared. You can set one up again any time.'
      )
    )
      return
      ...
      {isContractor && (
        <>
          ...
          <Section>
            ...
            >
              <strong style={{ color: 'var(--color-text)' }}>Optional.</strong> Generate a Solana
              wallet address that clients can use to pay you directly in crypto. TraydBook only
              stores your public key — your seed phrase and private key are never sent to our
              servers.
            </p>
            ...
            {walletLoading || walletPubkey === undefined ? (
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                  ...
                  <div
                    style={{ fontFamily: 'var(--font-condensed)', fontSize: 14, fontWeight: 700 }}
                  >
                    Active Wallet
                  </div>
                  <span
                ...
                >
                  ...
                  <div style={{ fontSize: 12, color: 'var(--color-text-muted)', lineHeight: 1.6 }}>
                    Use the 12-word seed phrase you saved during setup. In Phantom:{' '}
                    <em>Add / Connect Wallet → Import Secret Recovery Phrase</em>. In Solflare:{' '}
                    <em>Access Existing Wallet → Mnemonic Phrase</em>.
                  </div>
                </div>
              </div>
            ) : (
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
                  ...
                  <div>
                    <div
                      style={{ fontFamily: 'var(--font-condensed)', fontSize: 15, fontWeight: 800 }}
                    >
                      Solana Wallet
                    </div>
                    <div style={{ fontSize: 12, color: 'var(--color-text-muted)' }}>
                      Accept crypto payments, import into Phantom or Solflare
                    </div>
                  </div>
                </div>
                <p
                ...
                >
                  Your wallet keypair and seed phrase are generated in your browser — they never
                  leave your device. TraydBook only stores your public key (wallet address).
                </p>
                <button
                  onClick={() => navigate('/wallet-setup')}
